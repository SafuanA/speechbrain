...
class TransformerLayer(nn.Module):
    ...
    def __init__(self, *,
        ...
        * `dropout_prob` is the probability of dropping out after self attention and FFN
        ...
        #accordinng to https://arxiv.org/pdf/2008.04659.pdf 2 FFNNS (PFFNN) are needed
        self.feed_forward = FeedForward(d_model, 2048, d_model)
...
class Encoder(nn.Module):
    ...
    def __init__(self, layer: TransformerLayer, n_layers: int, d_model: int, dropout_ffnn: float):
        super().__init__()
